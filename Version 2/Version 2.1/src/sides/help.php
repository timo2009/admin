      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-3">
            <article class="leistungs-teaser-box">
              <h2>Das Hochladen</h2>
              <p>
                Auf der Startseite befindet sich ein Hochlade Formular, einfach nur die Datei(en) auswählen und auf Upload klicken, folgende Dateitypen sind erlaubt: Viedeo, Audio, Bild und Text.
                Nach dem Hochladen erscheint ein Fenster mit Informationen über die Dateien (z.B abloluten Pfad, Größe, ...). Eine schon existierende Datei wird nicht überschrieben. Die Dateien werden nach Typ sortiert abgelegt, um zu wissen vo sie sich befinden gibt es einen Absoluten Pfad zu der Datei. PHP Dateien können nicht Hochgeladen werden.
              </p>
            </article>
          </div>
          <div class="col-3">
        ...
        <div class="row">
          <div class="col-3">
            <article class="leistungs-teaser-box">
              ...
              <p>
                Wenn man, in der gerade beschriebenen Tabelle auf den Verlinkten Pfad geht, gelangt man in auf eine Vorschau (bei Audios und Viedeos werden die jeweiligen Dateien direkt abgespielt) wo ganz oben ein blaues Info Feld ist. In diesem gibt es einen Link zurück und zum Herunterladen, sowie zahlreiche Informationen.
              </p>
          </article>
          </div>
          <div class="col-3">
        ...
        <div class="col-3">
            <article class="leistungs-teaser-box">
              ...
              <p>
                Um eine Datei umzubenennen, in der Tabelle auf den Stift drücken und den neuen Namen eingeben, anschließend auf Umbenennen klicken.
              </p>
          </article>
          </div>          
          <div class="col-3">
            <article class="leistungs-teaser-box">
              ...
              <p>
                Die User kann man auf der User Verwalten Seite ansehen und mit den verschiedenen Links User erstellen, löschen, bearbeiten, Passwörter ändern.
              </p>
          </article>
          </div>
          <div class="col-3">
            <article class="leistungs-teaser-box">
              <h2>Log File</h2>
              <p>
                Jede Aktion eines Users (ausgenommen Aktionen mit Usern) wird gespeichert. Diese sind in der Useransicht als Berechtigter zu sehen.
              </p>
          </article>
          </div>
        </div>
