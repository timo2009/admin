...
class AdminClass
{
	...
	public function listFiles($type)
	{
		...
		if ($type!="all") {
	    	...
	    	$files=$this->listFilesFromFolder("../../../html/", $type, $files, true);
	    	$files=$this->listFilesFromFolder("../../../html/medien/audio/", $type, $files, true);
	    	$files=$this->listFilesFromFolder("../../../html/medien/img/", $type, $files, true);
	    	$files=$this->listFilesFromFolder("../../../html/medien/video/", $type, $files, true);
		}
		return $files;
	}
