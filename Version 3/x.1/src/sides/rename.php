...
<?php if ($user->checkUserRights("read")): ?>
        ...
        if (!$rename) {
            ...
            ?>
                <script type="text/javascript">
                    ...
                    location.href = "<?php echo isset($_GET['pages']) ? 'pages.php' : 'list.php'; ?>?type=<?php echo $_GET['type']; ?>";
                </script>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <form method="POST"
                      action="rename.php?name=<?php echo $_GET['name']; ?>&type=<?php echo $_GET['type']; ?><?php echo isset($_GET['pages']) ? '&pages=True' : ''; ?>"
                      class="form-outline">
                    <div class="form-group">
                        <label for="old">Alter Name</label>
                        <input type="text" class="form-control" id="old"
                               value="<?php echo $admin->returnFilename($_GET['name']); ?>" readonly name="old">
                    </div>

                    <div class="form-group">
                        <label for="new">Neuer Name</label>
                        <input type="text" class="form-control" id="new" required
                               value="<?php echo $admin->returnFilename($_GET['name']); ?>" name="new">
                    </div>
