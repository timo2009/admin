	                ...
	                <td>
	                	...
	                	<a :href="item.deleteLink" onclick="FensterOeffnen(this.href, true); return false" target="_blank">
	                		<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
									...
									<?php endif; ?>
										<a :href="item.renameLink"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
